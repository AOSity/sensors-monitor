...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|LCD_DC_Pin|LCD_RST_Pin|LD3_Pin
                          |LCD_CS_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : TCH_RST_Pin */
  GPIO_InitStruct.Pin = TCH_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TCH_RST_GPIO_Port, &GPIO_InitStruct);
